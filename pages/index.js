...
export default class Home extends React.Component {
  ...
  render() {
    return (
      <>
        <Head>
          <title>{this.state.anonymous ? "My Name" : "Isaac Hilton-VanOsdall"}</title>
        </Head>
        <div className="w-1/12 fixed right-3 top-mid"> 
          <NavItems current={this.state.currPage} scroll={this.scroll}/>
        </div>
        <div className="container mx-16 h-10v pt-12 flex flex-row justify-between" id="top">
        ...
        <div className="container mx-16 h-10v pt-12" id="projects">
        ...
        <div className="container mx-16 h-10v pt-12" id="aboutme">
            <h1 className="text-5xl font-bold font-nunito text-left">About Me</h1>
        </div>
        <div className="container mx-auto w-10/12 pt-12 h-83v flex flex-col justify-between">
